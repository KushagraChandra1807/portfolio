    ...
    <section id="about" className="c-space section-spacing">
        ...
        md:auto-rows-[18rem] mt-12">
            ...
            grid-1">
                ...
                />
                <div className="z-10">
                    <p className="headtext">Hi,I'm Kushagra Chandra</p>
                    <p className="subtext">
...
<div className="grid-black-color grid-3">
  <div className="z-10 w-[70%]">
    <p className="headtext">From Concept to Commit.</p>
    <p className="subtext">
      I transform ideas into production-ready solutions with clean code,
